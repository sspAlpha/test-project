...
const GraphQLConnectedDemo = (props) => {
    ...
    return (
        <div data-e2e-id="graphql-connected">
            ...
            <p>
                Connected GraphQL executes GraphQL queries directly against the
                Sitecore GraphQL endpoint. You can review the query execution in
                the browser devtools network tab. Note that Apollo Client
                maintains a query cache - so the same query will not execute
                twice (i.e. after route changes) unless either the page is
                refreshed, or the <em>fetch policy</em> is set to not use the
                cache. Consult the Apollo documentation for details.
            </p>
            ...
            {datasource && (
                <div>
                    ...
                    <br />
                    sample1 (editable):{' '}
                    <Text field={datasource.sample1?.jsonValue} />
                    <br />
                    sample2:
                    <br />
                    <ul>
                        ...
                        <li>
                            editable:{' '}
                            <Link field={datasource.sample2?.jsonValue} />
                        </li>
                        <li>
