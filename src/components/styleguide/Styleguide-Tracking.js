    ...
    render() {
        ...
        return (
            <StyleguideSpecimen {...this.props} e2eId="styleguide-tracking">
                {disconnectedMode && (
                    <p>
                        The tracking API is only available in connected,
                        integrated, or headless modes.
                    </p>
                )}
                {!disconnectedMode && (
                    <div>
                        <p className="alert alert-warning">
                            Note: The JSS tracker API is disabled by default.
                            Consult the{' '}
                        ...
                        <div className="row">
                            <fieldset className="form-group col-sm">
                                ...
                                <p>
                                    ...
                                    <code>
                                        /sitecore/system/Settings/Analytics/Page
                                        Events
                                    </code>
                                </p>
                                <label htmlFor="event">
                            ...
                            <fieldset className="form-group col-sm">
                                ...
                                <p>
                                    ...
                                    <code>
                                        /sitecore/system/Marketing Control
                                        Panel/Goals
                                    </code>
                                </p>
                        ...
                        <div className="row">
                            <fieldset className="form-group col-sm">
                                ...
                                <p>
                                    Track arbitrary page views for custom
                                    routing or offline use. Note that Layout
                                    Service tracks page views by default unless{' '}
                                    <code>tracking=false</code> is passed in its
                                    query string.
                                </p>
                            ...
                            <fieldset className="form-group col-sm">
                                ...
                                <p>
                                    The tracking API supports pushing a whole
                                    batch of events in a single request. This
                                    can be useful for queuing strategies or
                                    offline PWA usage.
                                </p>
                                <button
                                    type="button"
                        ...
                        <div className="row">
                            <fieldset className="form-group col-sm">
                                ...
                                <p>
                                    Tracking data is not pushed into the
                                    xConnect service until your session ends on
                                    the Sitecore server. Click this button to
                                    instantly end your session and flush the
                                    data - great for debugging and testing.
                                </p>
                                <p className="alert alert-warning">
                                    Note: By default <em>anonymous</em> contacts
                                    will not be shown in Experience Profile. If
                                    your interactions are not showing up in
