    ...
    return (
        <StyleguideSpecimen {...props} e2eId="styleguide-edit-frame">
            <EditFrame {...getEditFrameProps(props.rendering.dataSource)}>
                This is the content that will be wrapped by edit frame in
                Experience Editor.
                <br />
                Try out the custom webedit buttons for a variety of tasks like
                executing javascript, or webedit commands. <br />
                Or use field edit buttons to author fields that are not usually
                editable in Experience Editor.
                <br />
                <br />
                <p style={{ color: applyRed ? 'red' : 'blue' }}>
                    This text will change color. Use the field edit button to
...
const getEditFrameProps = (dataSource) => {
    return {
        ...
        title: 'jssEditFrame',
        tooltip:
            'Perform editing anywhere while not tied to a rendering, placeholder or field',
